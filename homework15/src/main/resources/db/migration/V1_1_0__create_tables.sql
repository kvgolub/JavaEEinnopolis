...
ADD CONSTRAINT fk_student FOREIGN KEY (studentId) REFERENCES students(id) ON UPDATE CASCADE ON DELETE CASCADE,
ADD CONSTRAINT fk_course FOREIGN KEY (courseId) REFERENCES courses(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
COMMENT ON COLUMN students_courses.studentId IS 'Идентификатор студента';
COMMENT ON COLUMN students_courses.courseId IS 'Идентификатор курса';
