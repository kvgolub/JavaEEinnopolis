...
public interface StudentCourseRepository extends JpaRepository<StudentCourse, Long>,
    ...
    @Query(nativeQuery = true, value = """
                ...
                INNER JOIN students.students_courses sc ON sc.student_id = s.id
                INNER JOIN courses.courses c ON c.id = sc.course_id
    ...
    @Query(nativeQuery = true, value = """
                ...
                SELECT
                	...
                	qc.course_id
                FROM queryCount qc
                INNER JOIN students.students s ON s.id = qc.student_id
