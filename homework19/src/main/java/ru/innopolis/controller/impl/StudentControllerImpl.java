...
public class StudentControllerImpl implements StudentController {
    ...
    @Override
    public ResponseEntity<List<StudentResponse>> findStudentsCertainAge(Integer age) {
        List<StudentResponse> studentsResponses = studentService.findStudentsCertainAge(age);
