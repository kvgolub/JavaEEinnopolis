...
public class StudentControllerTest {
    ...
    @Test
    void findStudentsCertainAgeControllerTest() throws Exception {
        Mockito.when(studentService.findStudentsCertainAge(Mockito.any(Integer.class))).thenReturn(studentsCertainAge);
