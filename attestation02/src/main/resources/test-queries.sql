...
--Выборка "На каком маршруте с самым большим пассажиропотоком будет эффективен самый вместительный автобус и сколько ему понадобится рейсов"
WITH
...
--Изменение Типа автобуса для записей "с гармошкой" на "низкопольный" в таблице Автобусы и удаление Типа автобуса "с гармошкой" из Таблицы Типа автобуса
