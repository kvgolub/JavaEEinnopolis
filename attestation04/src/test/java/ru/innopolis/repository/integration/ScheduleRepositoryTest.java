...
class ScheduleRepositoryTest {
    ...
    void deleteByIdAsSoft() {
        var response = scheduleRepository.deleteByIdAsSoft(1L);

        assertThat("Тестирование \"Логическое удаление записи Расписание\"", response, equalTo(1));
    }

    @Test
    void deleteAllAsSoft() {
        var response = scheduleRepository.deleteAllAsSoft();

        assertThat("Тестирование \"Логическое удаление всех записей Расписание\"", response, equalTo(12));
    }
}
