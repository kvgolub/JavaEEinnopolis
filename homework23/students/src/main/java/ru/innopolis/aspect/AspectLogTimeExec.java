...
public class AspectLogTimeExec {
    ...
    public static final String POINTCUT_CREATE_STUDENT = "execution(public * ru.innopolis.controller.impl.StudentControllerImpl.createStudent(..))";
    public static final String POINTCUT_CREATE_ONE_STUDENT_MANY_COURSES = "execution(public * ru.innopolis.controller.impl.StudentCourseControllerImpl.createOneStudentManyCourses(*))";
    public static final String POINTCUT_FIND_ALL_STUDENTS_ONE_COURSE = "execution(public * ru.innopolis.controller.impl.StudentCourseControllerImpl.findAllStudentsOneCourse(..))";
